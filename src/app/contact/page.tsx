...
export const metadata: Metadata = {
  title: "Contact ZHONG XIN WOOD | Okoumé Sawn Timber okoume plywood Enquiries",
  description:
    "Contact ZHONG XIN WOOD for Gabon Okoumé sawn timber okoume plywood enquiries. Email, WhatsApp, or LinkedIn — we respond within 24 hours. Based in GSEZ Nkok, Gabon.",
};
