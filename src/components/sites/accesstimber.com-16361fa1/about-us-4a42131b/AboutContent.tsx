...
const CARDS = [
  {
    icon: "🎯",
    title: "Our Mission",
    text: "Supply the highest quality Gabon Okoumé sawn timber at competitive prices, with full traceability and consistent quality in every shipment.",
  },
  {
    icon: "🏭",
    ...
    <div className="au-section">
      <div className="au-lead">
        ...
        <p>
          ...
          sawn timber manufacturer and processor, based in{" "}
          <strong>GSEZ Nkok, Gabon</strong>. We process Gabon-origin Okoumé
          directly at source, offering kiln-dried sawn timber with reliable
      ...
      <div className="au-highlight">
        ...
        <p>
          <strong>Okoumé Sawn Timber</strong> — Scientific name: Aucoumea
...
export function AboutCta() {
  return (
    <section className="au-cta">
      ...
      <p>
        Contact our team to discuss your Okoumé sawn timber requirements and
