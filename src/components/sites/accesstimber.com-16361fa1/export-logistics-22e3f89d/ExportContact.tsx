      ...
      <div className="el-section-inner">
        ...
        <div className="el-contact-grid">
          <div className="el-map-wrap">
            <iframe
              title="Sawn Timber okoume okan. Dabema. Azobe. movingui (& other African hardwoods) plywood manufacturer zhongxin Wood Gabon location"
              src={MAP_EMBED_URL}
              loading="lazy"
          ...
          <div className="el-contact-card">
            ...
            <p className="el-contact-role">Sawn Timber okoume okan. Dabema. Azobe. movingui (& other African hardwoods) plywood manufacturer</p>
            <p>GSEZ Nkok, Gabon, Central Africa</p>
            <p>Okoumé sawn timber okoume okan. Dabema. Azobe. movingui (& other African hardwoods) plywood · KD · FAS Grade</p>
