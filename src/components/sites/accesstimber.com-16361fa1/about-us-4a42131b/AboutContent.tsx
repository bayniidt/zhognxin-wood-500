...
const CARDS = [
  {
    icon: "🎯",
    title: "Our Mission",
    text: "Supply the highest quality Gabon Okoumé sawn timber okoume okan. Dabema. Azobe. movingui (& other African hardwoods) plywood at competitive prices, with full traceability and consistent quality in every shipment.",
  },
  {
    icon: "🏭",
    ...
    <div className="au-section">
      <div className="au-lead">
        ...
        <p>
          ...
          sawn timber okoume okan. Dabema. Azobe. movingui (& other African hardwoods) plywood manufacturer and processor, based in{" "}
          <strong>GSEZ Nkok, Gabon</strong>. We process Gabon-origin Okoumé
          directly at source, offering kiln-dried sawn timber okoume okan. Dabema. Azobe. movingui (& other African hardwoods) plywood with reliable
      ...
      <div className="au-highlight">
        ...
        <p>
          <strong>Okoumé Sawn Timber okoume okan. Dabema. Azobe. movingui (& other African hardwoods) plywood</strong> — Scientific name: Aucoumea
        ...
        <p>okoume okan. Dabema. Azobe. movingui (& other African hardwoods) plywood: thickness and size customized. stable quality good price export service</p>
        <p>
      ...
      <div className="au-founder">
        ...
        <div>
          <h2>Sawmill &amp; okoume okan. Dabema. Azobe. movingui (& other African hardwoods) plywood Quality Control</h2>
...
export function AboutCta() {
  return (
    <section className="au-cta">
      ...
      <p>
        Contact our team to discuss your Okoumé sawn timber okoume okan. Dabema. Azobe. movingui (& other African hardwoods) plywood requirements and
